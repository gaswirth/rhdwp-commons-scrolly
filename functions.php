...
function rhd_enqueue_styles()
{
	...
	wp_register_style( 'rhd-enhanced', RHD_THEME_DIR . '/css/enhanced.css', array( 'rhd-main' ), '1', 'all' );
...
function rhd_add_editor_styles()
{
	...
	$font_url = '//fonts.googleapis.com/css?family=Roboto:400,400italic,700,700';
